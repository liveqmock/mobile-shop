<template>
    ...
    <div class="Ninfo" v-if="Ninfo"   style="background:#efeff0">
      ...
      >
        <div class="xin-li" v-for="(order,index) in aftersaleOrderList"  name='div'>
            <div class="li-one">
            ...
            <div class="goods">
                <div class="goods-li"  v-for="goods in order.goods" @click="goContent(order,goods)">
                  ...
                  <div class="li-text">
                    ...
                    <span v-if="goods.is_after_sale!=0"  class="shouhou" style="background: rgb(255, 255, 255); border: 1px solid rgb(141, 141, 141); color: rgb(119, 188, 31);">售后详情</span>  
                     <span class="shouhou" v-if="goods.is_after_sale==0" @click.stop="Aftersale(order,goods)" >申请售后</span>
                  </div>
                 </div>
...
export default {
  ...
  created() {
    this.$http.get(this.apiUrl, {
      ...
      .then((res) => {
         this.aftersaleOrderList = res.body.data;
  ...
  methods: {
    ...
    Aftersale: function(order, goods) {
       this.$router.push({
          name: 'afterSalesService',
          params: {
            orderSn: order.order_id,
            goodsId: goods.goods_id,
            goodsAttrId: goods.goods_attr_id
          }
        }) 
        ...
        this.$http.get(this.apiUrl, {
          ...
          if (data.data.error == 99) {
            ...
            let content = data.data.data;
             this.aftersaleOrderList = this.aftersaleOrderList.concat(content)
          };
