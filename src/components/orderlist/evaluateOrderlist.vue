<template>
    ...
    <div class="Ninfo" v-if="Ninfo"   style="background:#efeff0">
      ...
      >
        <div class="xin-li" v-for="(order,index) in evaluateOrderlist"  name='div'>
            <div class="li-one">
            ...
            <div class="goods">
                ...
                <div class="goods-button">
                  ...
                  <div >
                    ...
                    <span class="ci" @click="goComment(order)" >立即评价</span>
                  </div>
...
export default {
  ...
  created() {
    ...
    this.$http.get(this.apiUrl, {
      ...
      .then((res) => {
         this.evaluateOrderlist = res.body.data;
        ...
        this.$http.get(this.apiUrl, {
          ...
          if (data.data.error == 99) {
            ...
            let content = data.data.data;
             this.evaluateOrderlist = this.evaluateOrderlist.concat(content)
          };
