...
<div class="coupon">
    ...
    <div class="offthestocks">
      ...
      <div class="xin-list" >
        <div class="info">
           ...
           <span class="coupon-mon">￥{{this.$route.query.denomina}}元</span>
           <p class="coupon-p">{{this.$route.query.third_party_name}}优惠券</p>
           <p class="leave-num">剩余{{leaveNum}}张</p>
            
           <p class="coupon-p2">有效期 <span class="coupou-ins">该券可以多次兑换</span></p> 

        </div>
        <div class="cou-right">
             <span class="num">{{this.$route.query.denomina}}</span>
     ...
     <div  class="ex-btn-box">
       <img @click="exchange" src="../images/exbtn.png" height="96" width="362" alt="">
     </div>
     </div>
    <div class="ins-text">
      <p class="ins-title">使用说明</p>
      <div class="ins-con">1.介绍</div>
    </div>
     <!-- 弹窗 -->
    ...
    <div class="mark-content">
          <p  class="mark-text">兑换提示</p>
           <p class="mark-text1">该商品将扣除你{{this.$route.query.denomina}}银票</p>
         <div  class="mark-btns" >
          <span @click.stop="showmark=false;showbigmark=false" >取消</span>
...
export default {
  ...
  methods:{
    ...
    surechange(key){
     ...
     this.$http.post(this.buyPointCouponsUrl, {
          ...
          denominaId: this.$route.query.denomina_id,
          num: 1
        }, this.headers)
        .then((res) => {
  ...
  created(){
    ...
    this.leaveNum =  this.$route.query.num;
